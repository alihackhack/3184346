...
def snap(phone):
    ...
    try:
        ...
        if "OK" in snapR:
            ...
            print(f'{g}(Snap) {w}(teror)کد ارسال شد')
...
def gap(phone):
    ...
    try:
        ...
        if "OK" in gapR:
            ...
            print(f'{g}(Gap) {w}(teror)کد ارسال شد')
...
def tap30(phone):
    ...
    try:
        ...
        if tap30R['result'] == "OK":
            ...
            print(f'{g}(Tap30) {w}(teror)کد ارسال شد')
...
'x-standard-divar-error': 'true'}
    ...
    try:
        ...
        if divarR["authenticate_response"] == "AUTHENTICATION_VERIFICATION_CODE_SENT":
            ...
            print(f'{g}(Divar) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    ...
    try:
        ...
        if torobR["message"] == "pin code sent":
            ...
            print(f'{g}(Torob) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            ...
            print(f'{g}(SnapFood) {w}(teror)کد ارسال شد')
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR['success'] == True:
            ...
            print(f'{g}(Sheypoor) {w}(teror)کد ارسال شد')
...
'x-xsrf-token': ''}
    ...
    try:
        ...
        if 'success' in okR:
            ...
            print(f'{g}(OfoghKourosh) {w}(teror)کد ارسال شد')
...
def alibaba(phone):
    ...
    try:
        ...
        if alibabaR["result"]["success"] == True:
            ...
            print(f'{g}(AliBaba) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    ...
    try:
        ...
        if smarketR['status'] == True:
            ...
            print(f'{g}(SnapMarket) {w}(teror)کد ارسال شد')
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    ...
    try:
        ...
        if gaR['Code'] == 1:
            ...
            print(f'{g}(GapFilm) {w}(teror)کد ارسال شد')
...
def sTrip(phone):
    ...
    try:
        ...
        if sTripR['status_code'] == 200:
            ...
            print(f'{g}(Strip) {w}(Ashkan)کد ارسال شد')
...
def filmnet(phone):
    ...
    try:
        ...
        if Filmnet['meta']['operation_result'] == 'success':
            ...
            print(f'{g}(Filmnet) {w}(teror)کد ارسال شد')
...
def drdr(phone):
    ...
    try:
        ...
        if drdr['status'] == 'success':
            ...
            print(f'{g}(DrDr) {w}(teror)کد ارسال شد')
...
def itool(phone):
    ...
    try:
        ...
        if ok['success'] == True:
            ...
            print(f'{g}(Itool) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok['status'] == True:
            ...
            print(f'{g}(AnarGift) {w}(teroe)کد ارسال شد')
...
'username': 'BimitoClient'
    ...
    try:
        ...
        if ok["messageCode"] == 201:
            ...
            print(f'{g}(Azki) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'ok':
            ...
            print(f'{g}(Chamedoon) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'success':
            ...
            print(f'{g}(BaniMode) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    ...
    try:
        ...
        if 'تایید شماره تلفن همراه' in lendoR:
            ...
            print(f'{g}(Lendo) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    ...
    try:
        ...
        if 'مدت زمان باقی‌مانده تا دریافت مجدد کد' in olgoo:
            ...
            print(f'{g}(NashrOlgoo) {w}(teror)کد ارسال شد')
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        ...
        if ok['code'] == '1':
            ...
            print(f'{g}(PakhshShop) {w}(teror)کد ارسال شد')
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        ...
        if ok['code'] == '1':
            ...
            print(f'{g}(DideNegar) {w}(teror)کد ارسال شد')
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        ...
        if ok['status'] == True:
            ...
            print(f'{g}(Baskol) {w}(teror)کد ارسال شد')
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if ok['status'] == 'SUCCESS':
            ...
            print(f'{g}(Kilid) {w}(teror)کد ارسال شد')
...
'x-creation-tags': '{"app":"web","client":"customer","os":"linux","device":"desktop","uri":"/accounts","fullPath":"/accounts","utms":"organic","landing_url":"basalam.com%2Faccounts","tag":[null]}'}
    ...
    try:
        ...
        if ok.status_code == 200:
            ...
            print(f'{g}(BaSalam) {w}(teror)کد ارسال شد')
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        ...
        if ok == 'send_sms':
            ...
            print(f'{g}(See5) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if ok["Parameters"] != None:
            ...
            print(f'{g}(Ghabzino) {w}(teror)کد ارسال شد')
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if ok['Message'] == "ثبت نام شما با موفقیت انجام شد":
            ...
            print(f'{g}(SimKhan) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if 'کد تایید 6 رقمی پیامک شده به شماره' in ok:
            ...
            print(f'{g}(DrSaina) {w}(teror)کد ارسال شد')
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if ok['status'] == 'ok':
            ...
            print(f'{g}(BinJo) {w}(teror)کد ارسال شد')
...
'X-Requested-With': 'XMLHttpRequest'}
    ...
    try:
        ...
        if liR['status'] == 'success':
            ...
            print(f'{g}(Limome) {w}(teror)کد ارسال شد')
...
'user-token': 'swS1oSzN22kTVTI8DqtRhUrgUfsKBiRdBeosjlczNV07XSbeVHB7R622Mw9O7uzp'}
    ...
    try:
        ...
        if liR['message'] == 'کاربر قبلا ثبت نام نکرده است':
            ...
            print(f'{g}(BimitoVip) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    ...
    try:
        ...
        print(f'{g}(SeebIrani) {w}(teror)کد ارسال شد')
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    ...
    try:
        ...
        print(f'{g}(MihanPezeshk) {w}(teror)کد ارسال شد')
...
"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0"
    ...
    try:
        ...
        if meR['isSuccess']:
            ...
            print(f'{g}(HamrahMechanic) {w}(teror)کد ارسال شد')
...
printLow(f'  Ali_TEROR {g}[+] {y}rubika: {w}@ali_12__2{g}    [+] {y}creator: {w}@ali_12__2 \n{y}system:\n    {g}[+] {y}Platform: {w}{System}\n    {g}[+] {y}Node: {w}{Node}\n  from art import text2art print(text2art("ali_teror"))   {g}[+] {y}Release: {w}{Release}\n\n')
